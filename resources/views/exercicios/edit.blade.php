    ...
    <div>
        <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('exercicios.update', $exercicio->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="grupo_muscular" class="block font-medium text-sm text-gray-700">Grupo Muscular</label>
                            <input type="text" name="grupo_muscular" id="grupo_muscular" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="descricao" id="descricao" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('descricao', $exercicio->descricao) }}" />
                            @error('descricao')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
